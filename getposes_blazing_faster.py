...
##Just modifiled a small bug in 2025,Ting
...
def main():
	...
	for chunk in chunk_dict:
		print(chunk) 
		gz_file = os.path.join(docking_dir, chunk, gz_file_name)
		lig_dict = process_gz(gz_file, lig_dict, chunk)
                print("DEBUG: docking_dir ->", docking_dir)
                print("DEBUG: chunk ->", chunk)
                print("DEBUG: gz_file_name ->", gz_file_name)
